        ...
        <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
                <div class="nav-profile-image">
                    <img src="{{ asset('frontend_admin/images/trend-avatar-1.jpg') }}" alt="profile">
                ...
                <div class="nav-profile-text d-flex flex-column">
                    <span class="font-weight-bold mb-2">{{ $admin->fullname }}</span>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="revenue">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('ad.monthly-revenue') }}">Monthly
                            Revenue</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('ad.weekly-revenue') }}">Weekly Revenue</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('ad.daily-revenue') }}">Daily Revenue</a>
                    </li>
                </ul>
            </div>
        </li>
