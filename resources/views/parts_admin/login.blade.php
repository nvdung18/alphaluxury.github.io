                ...
                <div class="row flex-grow">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form class="pt-3" action="{{ route('checkloginadmin') }}" method="POST">
                                @csrf
                                ...
                                @endif
                                @if (session('message'))
                                <span class="alert alert-danger notification-login-admin" style="color: red;">
                                    {{ session('message') }}
                                </span>
                                @endif
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputEmail1"
                                        placeholder="Username" name="nameUser">
                                </div>
